...
const geaenderterZoo: Omit<ZooDtoCore, 'entranceFee'> & {
    ...
    designation: 'Berliner Zoo', // Entspricht dem 'designation' Feld im DTO
    entranceFee: 12, // Entspricht dem 'entranceFee' Feld im DTO, als Decimal
...
const geaenderterZooIdNichtVorhanden: Omit<ZooDtoCore, 'entranceFee'> & {
    ...
    designation: 'Frankfurter Zoo', // Entspricht dem 'designation' Feld im DTO
    entranceFee: 11, // Entspricht dem 'entranceFee' Feld im DTO, als Decimal
    open: true, // Optional, entsprechend dem DTO
    homepage: 'https://geaendert.put.rest', // Optional, entsprechend dem DTO
};
