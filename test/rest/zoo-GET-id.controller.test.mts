...
import { type Zoo } from '../../src/zoo/entity/zoo.entity.js';
...
describe('GET /rest/:id', () => {
    ...
    test.concurrent('zoo for existing Id', async () => {
        // given
        const url = `/${idVorhanden}`;

        // when
        const { status, headers, data }: AxiosResponse<Zoo> =
    ...
    test.concurrent('zoo for nonexisting Id', async () => {
        // given
    ...
    test.concurrent('zoo for invalid id', async () => {
        // given
        const url = `/${idFalsch}`;
    ...
    test.concurrent('zoo for existng id with E-Tag', async () => {
        // given
